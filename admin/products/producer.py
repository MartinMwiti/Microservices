...
def publish(method, body):
    ...
    channel.basic_publish(exchange='', routing_key='main', body=json.dumps(body), properties=properties) # before sending anything we need to convert it to json before sending
